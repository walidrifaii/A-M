    ...
    <>
      ...
      >
        <div className="flex-shrink-0 pt-0 lg:pt-6">
          <h1 className={`hidden lg:block text-[28px] lg:text-[30px] text-gray-500  mb-8 
           `}>
            Manage
          </h1>
          <Link href={'/pages'} >
          ...
          {menuItems.map((item) => {
            ...
            return (
              <Link
                ...
                className={`
                  flex items-center gap-3 px-4 py-4 lg:py-4 rounded-l-full transition-all duration-200
                  
                  ${isActive
                    ? 'bg-[#fcebc0] font-centurygothicbold text-amber-400 '
              ...
              >
                ...
                <span className={`${  isActive ? 'font-fontArabicBold' : ''}  text-[16px] `}>{item.label}</span>
              </Link>
            )
          })}
        </nav>
