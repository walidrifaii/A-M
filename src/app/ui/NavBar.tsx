...
function Drawer({
  ...
  return (
    <aside
      role="dialog"
      aria-modal="true"
      className={`fixed right-0 top-0 z-[81] h-dvh w-[86%] max-w-sm bg-[var(--background)] text-[var(--foreground)] shadow-2xl transition-transform duration-300 transform-gpu ${open ? "translate-x-0" : "translate-x-full"
        } rounded-l-2xl`}
    >
